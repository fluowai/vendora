...
import { Building2, LayoutDashboard, LogOut, Menu, Palette, Users, X } from "lucide-react"
    ...
    <div className="flex flex-col h-full">
      <div className="p-6 border-b border-border">
        <div className="flex items-center gap-3">
          ...
          <div>
            <span className="font-display font-bold text-lg text-text">White Label</span>
        ...
        {navItems.map((item) => (
          <NavLink
            ...
            className={({ isActive }) => cn(
              ...
              isActive ? "bg-teal-50 text-teal-700 border border-teal-100" : "text-muted hover:bg-bg hover:text-text"
            )}
          >
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center gap-3 px-4 py-3 mb-2">
          <div className="w-8 h-8 rounded-lg bg-teal-50 flex items-center justify-center text-teal-700 font-bold text-sm">
      ...
      <main className="flex-1 lg:ml-64">
        <header className="h-16 border-b border-border flex items-center justify-between px-4 lg:px-8 bg-surface/80 backdrop-blur-md sticky top-0 z-30">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-teal-50 border border-teal-100 rounded-lg">
            ...
            <span className="text-xs font-bold text-teal-700 uppercase tracking-wider">Super Admin White Label</span>
          </div>
          <button onClick={() => navigate("/app/dashboard")} className="text-sm text-muted hover:text-text bg-bg border border-border rounded-xl px-4 py-2">
            App
          </button>
        </header>
